...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  var loadingWrapper = document.querySelector('[fs-hacks-element="hack10-loading-wrapper"]');
  ...
  var clearCookiesButton = document.querySelector('[fs-hacks-element="clear-cookie"]');
