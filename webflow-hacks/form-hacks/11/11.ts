...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // get elements
  const page_url = document.querySelector<HTMLDivElement>(SHOW_PAGE_URL_SELECTOR);
  const page_url_input = document.querySelector<HTMLInputElement>(PAGE_URL_INPUT_SELECTOR);
