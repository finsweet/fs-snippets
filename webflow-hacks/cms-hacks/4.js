...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const filterLinks = document.querySelectorAll('[fs-hacks-element="hack4-filter-button"]');
  const sections = document.querySelectorAll('[fs-hacks-element="hack4-cms-anchor-section"]');
